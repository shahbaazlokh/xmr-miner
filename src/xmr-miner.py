...
def init():
    ...
    parser.add_argument('-v', '--variant', default = '1', help = 'pow variant 0 (original) or 1 (April 2018 fork) (default = 1)')
    ...
    if (options.url and options.username) or (options.file):
        ...
        print('  4  VARIANT     pow variant 0 (original) or 1 (April 2018 fork) (default = 1)')
